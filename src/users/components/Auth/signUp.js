        ...
        <form className="text-center" style="color: #757575;" action="#!">
            ...
            <div className="form-row">
                ...
                <div className="col">
                    ...
                    <div className="md-form">
                        <input type="email" id="materialRegisterFormLastName" className="form-control"></input>
            ...
            <div className="md-form">
                <input type="password" id="materialRegisterFormPhone" className="form-control" aria-describedby="materialRegisterFormPhoneHelpBlock"></input>
            ...
            <div className="form-check">
                <input type="checkbox" className="form-check-input" id="materialRegisterFormNewsletter"></input>
